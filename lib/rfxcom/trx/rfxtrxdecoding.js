...
class rfxtrxdecoding extends newLib {
    ...
    constructor() {
        ...
        this.debug = false;//  to set debug on or off 
        ...
        this.receiveSerialData = (data, rx) => {
            ...
            simpel.log('lllllllllllllllllllooooooooooooooooooooogggggggggggggggggggg')
        ...
        this.temphumidity19Handler = (data) => {
            ...
            let filledDevice =
                {
                    ...
                    type: null,
                    name: id,
                    rx: [this.rx], // { type: null, index: null } of rxtx where signals are received from for this device  the device id of a rxtx is its ip
            ...
            if (!this.contains(driverTEMPHUM.homeyDevices, filledDevice)) {
                ...
                const device = driverTEMPHUM.getDevice({ id: id });
            ...
            //if (!this.contains(Homey.app.homeyDevices, homeyDevice)) {
            //    Homey.app.homeyDevices.push(homeyDevice);
            //} else {

            //  //  Homey.app.updateCapabilitiesHomeyDevice(homeyDevice);
            //}
        ...
        this.temp19Handler = (data) => {
            ...
            //    driverTEMP.updateCapabilitiesHomeyDevice(filledDEvice);
            //}
