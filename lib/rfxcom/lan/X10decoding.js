...
class X10decoding extends libNew {
    ...
    constructor() {
        ...
        this.processX10Data = (Fdevice, houseCode, unitCodeString, address, command) => {
            ...
            Homey.app.triggerflow2(triggerresult)
        ...
        this.SendHexStringToLanRxTx = (hexSendA) => {
           ...
           let rfxComDevices = Homey.ManagerDrivers.getDriver("RfxCom").getDevices()
            ...
            for ( let rfxComDevice of rfxComDevices)  {
                ...
                if ( rfxComDevice.rfxComType == 'RxTxLan' || rfxComDevice.rfxComType == 'TxLan' ) 

                rfxComDevice.transceiver.clientTx.sendCommandTxLan(hexSendA)
        ...
        this.sendCommandTrx = ( houseCodeString, unitCodeString, commandString ) =>
        {
            ...
            this.lib.log( `sendcommandtrx  houdecode ${houseCodeString}  unitCodeString  ${unitCodeString}  commandString ${commandString}` );
            ...
            sendArray[0] = 0x07;
            sendArray[1] = 0x10;  // lightning 1
            sendArray[2] = 0x00;  // subtype 
            sendArray[3] = 0x01;  // sequencenumber
            ...
            if ( commandString == "bright" )
            {
                sendArray[6] = 0x03
            }
            if ( commandString == "dim" )
            {
                sendArray[6] = 0x02
            }
            ...
            this.lib.log( `sendBufferb rfxtrx   `, sendBuffer )
            ...
            for ( let rfxComDevice of rfxComDevices )
            {
                ...
                if ( rfxComDevice.rfxComType == 'RfxTrx' )

                    rfxComDevice.transceiver.clientRx.sendCommandTrx( sendBuffer )
