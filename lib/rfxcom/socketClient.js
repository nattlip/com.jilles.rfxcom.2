...
class socketClient extends newLib {
    ...
    // capability = tx or rx
    constructor(capability, ip, port, type) {
        ...
        this.openClient = (capability, ip, port, type) => {
            ...
            if (capability == 'rx') {
                ...
                if (this.capability == 'rx') {
                    ...
                    this.client.on('connect', () => {
                        ...
                        if (this.type == 'RxLan' || this.type == 'RxTxLan') {
                            ...
                            this.lib.log(`rxtx type  ${type}  ip ${ip}  port ${port}`);
                            //this.client.setEncoding('hex')
                ...
                this.client.on('data', (dataStr) => {
                    ...
                    this.lib.log(`data !! ip ${this.ip} port ${this.port} response  ${dataStr} `)
                    ...
                    if (this.type == 'RxLan' || this.type == 'RxTxLan') {
                      ...
                      //              this.lib.log('lengthbyte rfxcom hex ', lengthbytehex)
                        ...
                        this.lib.log(`data from rfxtrx  ${dataStr}   , type of data   ${typeof dataStr}  `)
            ...
            // onlöy txlan or rxtxlan
                ...
                this.client.on('data', (dataStr) => {
                    ...
                    if (this.type == 'RxLan' || this.type == 'RxTxLan') {
                        ...
                        let rx = { id: this.ip, type: this.type, ip: this.ip, rx: this.rx, tx: null }
